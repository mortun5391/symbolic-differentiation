Вот пример `README.md` для вашего проекта, который соответствует требованиям задания и предоставляет всю необходимую информацию для пользователей и разработчиков:
